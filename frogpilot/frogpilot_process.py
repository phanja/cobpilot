...
def transition_offroad(frogpilot_planner, thread_manager, sm, params, time_validated):
...
def frogpilot_thread():
  ...
  while True:
    ...
    if not started and started_previously:
      transition_offroad(frogpilot_planner, thread_manager, sm, params, time_validated)
