...
def update_toggles(frogpilot_variables, started, thread_manager, time_validated, params, frogpilot_toggles):
...
def frogpilot_thread():
  ...
  while True:
    ...
    if params_memory.get_bool("FrogPilotTogglesUpdated"):
      frogpilot_toggles = update_toggles(frogpilot_variables, started, thread_manager, time_validated, params, frogpilot_toggles)
